...
class hipaymobileivr extends Module
{
    public function __construct()
    {
        $this->name = 'hipaymobileivr';
        ...
        $this->displayName = $this->l('Automated Hotline HiPay Mobile Premium Services');
        $this->description = $this->l('Simplify how you manage calls by setting up a hotline for your PrestaShop store quickly and free of charge.');
